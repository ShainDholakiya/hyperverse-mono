	...
	IHyperverseModule
{
	...
	mapping(string => string) _metadata;  
	...
	function addImage(uint256 imageId, string _imageURL) isTenantOwner returns (uint256) {
		_images[imageId] = _imageURL;
		return imageId;
	}
